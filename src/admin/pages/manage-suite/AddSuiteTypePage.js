                ...
                <SelectInput
                  value={
                    formData.amenities.value[
                      formData.amenities.value.length - 1
                    ] ?? ""
                  }
                  onChange={handleListFieldUpdate("amenities", "list")}
                  items={Amenities}
                  name={"amenities"}
              ...
              {formData?.amenities?.value.map((item, index) => (
                <Grid item xs={6} sm={6} md={4} key={index}>
                  <AmenitiesCard
                    title={item}
                    onClick={() =>
                      handleRemoveListItem("amenities", "list", item)
                    }
                  />
                </Grid>
              ))}
...
export default AddSuiteTypePage;
